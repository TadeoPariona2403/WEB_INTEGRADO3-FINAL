...
function esincorrecto(array $parametros){
...
function validaContrasena($password, $repassword){
...
function registraCliente(array $datos, $con) {
    $sql = $con->prepare("INSERT INTO clientes (nombres, apellidos, email, telefono, dni, estatus, fecha_a) VALUES (?, ?, ?, ?, ?, 1, now())");
...
function usuExists($usuario, $con) {
